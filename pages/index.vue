...
<template>
  <main class="mx-auto flex max-w-5xl flex-col gap-8 px-6 py-16 text-gray-700">
    ...
    <p class="font-semibold">Специализирани сме в:</p>
    ...
    <ul class="list-disc space-y-2 pl-5">
      ...
      <li>
        <strong>Вентилационни системи</strong> - проектиране, изграждане и обслужване на вентилация
        за домове, офиси и обекти.
      </li>
      <li>
        <strong>Цялостни и частични ремонти</strong> - ремонт на бани и кухни, довършителни работи,
        изолации и външни подобрения.
      </li>
      <li>
